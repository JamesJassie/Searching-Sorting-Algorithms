...
namespace AlgorithmAss1
{
    class SortingAlgorithms
    {
        ...
        public List<StoredData> sortDateAscendingA1(List<StoredData> listToSort)
        {
            ...
            //###################################################################################
            StoredData temp;
            for (int n = 0; n < listToSort.Count; n++)
            {
                for (int i = 0; i < listToSort.Count - 1; i++)
                {
                    countOfRepetitions++;
                    if (listToSort[i].TxDate > listToSort[i + 1].TxDate)
                    {
                        temp = listToSort[i];
                ...
                listToSort.First().SearchTypeAndTime = "Using 'DateAscAlg1' sort Date Ascending";//*** Change 'DateAscAlg1' for the algorithm used by you
        ...
        public List<StoredData> sortDateAscendingA2(List<StoredData> listToSort)
        {
            ...
            //###################################################################################
            listToSort.First().SearchTypeAndTime = "Using 'DateAscAlg2' sort Date Ascending";//*** Change 'DateAscAlg2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; //rewrite to show user the number of steps (loops) this algorithm has made to sort the data
            // *** your sorted data should be placed in 'listToSortA1' 
            return listToSort;
        ...
        public List<StoredData> sortDateDescendingA1(List<StoredData> listToSort)
        {
            ...
            for (int n = 0; n < listToSort.Count; n++)
            {
                ...
                for (int i = 0; i < listToSort.Count - 1; i++)
                {
                    ...
                    if (listToSort[i].TxDate < listToSort[i + 1].TxDate)
                    {
                        DateTime temp = listToSort[i].TxDate;
                        listToSort[i].TxDate = listToSort[i + 1].TxDate;
                        listToSort[i + 1].TxDate = temp;
                    }
                }
            }
            //###################################################################################
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DateDesAlg1' sort Date Descending"; //*** Change 'DateDesAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
        ...
        public List<StoredData> sortDateDescendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DateDesAlg2' sort Date Descending"; //*** Change 'DateDesAlg2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions;  
            return listToSort;
        }
        ...
        public List<StoredData> sortOpenAscendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'OpenAscAlg1' sort Open Ascending"; //*** Change 'DateDA2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort; 
        }
        ...
        public List<StoredData> sortOpenAscendingA2(List<StoredData> listToSortA2)
        {
            ...
            listToSortA2.First().SearchTypeAndTime = "Using 'OpenAscAlg2' sort Open Ascending"; //*** Change 'DateDA2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
        ...
        public List<StoredData> sortOpenDescendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'OpenDescAlg1' sort Open Ascending"; //*** Change 'DateDA2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortOpenDescendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'OpenDescAlg2' sort Open Ascending"; //*** Change 'DateDA2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions;  
            return listToSort;
        }
        ...
        public List<StoredData> sortCloseAscendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'CloseAscAlg1' sort Close Ascending"; //*** Change 'CloseAscAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions;  
            return listToSort; 
        }        
        ...
        public List<StoredData> sortCloseAscendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'CloseAscAlg2' sort Close Ascending"; //*** Change 'CloseAscAlg2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortVolAscendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'VolAscAlg1' sort Volume Ascending"; //*** Change 'VolAscAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortVolAscendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'VolumeAscAlg2' sort Volume Ascending"; //*** Change 'VolumeAscAlg2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortVolDescendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'VolDescAlg1' sort Volume Descending"; //*** Change 'VolDescAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortVolDescendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'VolumeDescAlg2' sort Volume Descending"; //*** Change 'VolumeDescAlg2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortDiffAscendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DiffAscAlg1' sort Difference Ascending"; //*** Change 'DiffAscAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortDiffAscendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DiffAscAlg2' sort Difference Ascending"; //** Change 'DiffAscAlg2' for the algorithm used by you ***
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions;  
            return listToSort;
        }
        ...
        public List<StoredData> sortDiffDescendingA1(List<StoredData> listToSort)
        {
            ...
            //loop through the data swapping by date in descending order
            for (int loop = 0; loop < listToSort.Count; loop++)
            {
                for (int index = 0; index < listToSort.Count - 1; index++)
                {
                    close1 = listToSort[index].Sh_diff;
                    leftHandSide = double.Parse(close1);
                    close2 = listToSort[index + 1].Sh_diff;
                    rightHandSide = double.Parse(close2);
                    if (leftHandSide < rightHandSide)
                    {
                        //swap the 2 dates over  
                        data1 = listToSort.ElementAt(index + 1);
                        listToSort[index + 1] = listToSort.ElementAt(index);
                        listToSort[index] = data1;
                    }
                    countOfRepetitions++;//count each iteration
                }
            }
            //#####################################################################################################
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DiffDescAlg1' sort Difference Descending"; //*** Change 'DiffDescAlg1' for the algorithm used by you ***
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortDiffDescendingA2(List<StoredData> listToSort)
        {
            ...
            for (int index = 1; index < listToSort.Count; index++)
            {
                ...
                {
                    countOfRepetitions++;//count each iteration
                    close1 = insertionSortedData[i - 1].Sh_diff;
                    leftHandSide = double.Parse(close1);
                    close2 = insertionSortedData[i].Sh_diff;
                    rightHandSide = double.Parse(close2);
                    if (leftHandSide < rightHandSide)
                    {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DiffDescAlg2' sort Difference Descending"; //***Change 'DiffDescAlg2' for the algorithm used by you ***
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; 
            return listToSort;
        }
        ...
        public List<StoredData> sortDayAscendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DayAscAlg1' sort Day Ascending"; //*** Change 'DayAscAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; //rewrite to show user the number of steps (loops) this algorithm has made to sort the data
        ...
        public List<StoredData> sortDayAscendingA2(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DayAscAlg2' sort Day Ascending"; //*** Change 'DiffDayAlg2' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; //rewrite to show user the number of steps (loops) this algorithm has made to sort the data
            // *** your sorted data should be placed in 'listToSortA1' 
            return listToSort;
        ...
        public List<StoredData> sortDayDescendingA1(List<StoredData> listToSort)
        {
            ...
            listToSort.First().SearchTypeAndTime = "Using 'DayDescAlg1' sort Day Descending"; //*** Change 'DayDescAlg1' for the algorithm used by you
            // place your total count of loops (countOfRepetitions) here
            listToSort.First().CountRepetitions = countOfRepetitions; //rewrite to show user the number of steps (loops) this algorithm has made to sort the data
